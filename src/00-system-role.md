...
booksRoot: /path/to/your/books          # books 目录的绝对路径（必须以 /books 结尾）
...
举例：如果配置文件里 `booksRoot = /path/to/your/books`，书名 = `<书名>`，那么 `<父目录>/books/<书名>/story/current_state.md` 展开为 `/path/to/your/books/<书名>/story/current_state.md`。
